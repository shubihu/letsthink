    ...
    <>
      ...
      {isOpen &&
        parent.children.map((child) => (
          <li key={`${parent.id}-${child.id}`} className={selectedItem === child.id ? 'selected' : ''} >
